...
def processfbx(file, patientID, filename):
    ...
    '''
    objpath = '/srv/Cyberman-Baby-Helmet/web_app/static/' + patientID+'_'+filename + '.obj'
    fbxpath = '/srv/Cyberman-Baby-Helmet/web_app/static/' + patientID+'_'+filename + '.fbx'
    file.save(fbxpath)
...
def processstl(file, patientID, filename):
    ...
    stlpath = '/srv/Cyberman-Baby-Helmet/web_app/static/' + patientID +'_'+ filename + '.stl'
    fbxpath = '/srv/Cyberman-Baby-Helmet/web_app/static/' + patientID +'_'+ filename + '.fbx'
    file.save(stlpath)
